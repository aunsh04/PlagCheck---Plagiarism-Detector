...
<body background="image.jpg">
	...
	<div class="setup">
		<h1  style="color: white;" class="setup" align="center"> <b>Professor Account Setup </b></h1>
	</div>

	<% session.setAttribute("instructor", 0); %>
	...
	<div class="superman" style="position:relative; ; left: 190px ; right: 5px">
		...
		<form name="setup" action="AdminController" onsubmit="return validateEmail();" method="get">
			...
			<table align="center">
				...
				<tr>
					<td style="color: white;"><label>Email: </label> <input style="color: black" type="text" id="email"
						name="email" /></td>
				</tr>
